...
BEGIN
    ...
    DECLARE @batch_start_time DATETIME,@batch_end_time DATETIME = GETDATE()

    BEGIN TRY

    -- ===============================================
    -- Step 1: Refresh silver.crm_cust_info
    -- ===============================================
    ...
    -- ===============================================
    -- Step 2: Refresh silver.crm_prd_info
    -- ===============================================
    ...
    -- ===============================================
    -- Step 3: Refresh silver.crm_sales_details
    -- ===============================================
    ...
    SELECT 
        ...
        sls_quantity,
        CASE 
            WHEN sls_price IS NULL OR sls_sales <= 0 THEN sls_price / NULLIF(sls_quantity,0)
            ELSE sls_price
        END
    ...
    -- ===============================================
    -- Step 4: Refresh silver.erp_cust_az12
    -- ===============================================
    ...
    -- ===============================================
    -- Step 5: Refresh silver.erp_loc_a101
    -- ===============================================
    ...
    -- ===============================================
    -- Step 6: Refresh silver.erp_px_cat_g1v2
    -- ===============================================
    ...
    PRINT 'All loads completed successfully in ' + CAST(DATEDIFF(second, @batch_start_time, @batch_end_time) AS NVARCHAR) + ' Seconds.'

    END TRY
    BEGIN CATCH
        PRINT '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++' 
        PRINT 'ERROR OCCURRED DURING load process for SILVER Layer'
        PRINT '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++' 
